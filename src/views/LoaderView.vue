<template>
    <div class="absolute left-0 right-0 bottom-0 h-screen bg-gray-200 grid place-items-center">
        <svg class="h-8 w-8 animate-spin" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
